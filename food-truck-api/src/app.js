...
// Customer Routes
app.get('/customer/dashboard', (req, res) => res.render('customer-dashboard', { title: 'Customer Dashboard', userId: req.query.userId || 1, username: req.query.username || 'Customer' }));
app.get('/customer/browse-trucks', (req, res) => res.render('browse-trucks', { title: 'Browse Trucks', userId: req.query.userId || 1, username: req.query.username || 'Customer' }));
